...
def read_index(filepath: str, encoding: str) -> dict:
...
def read_text(filepath: str, encoding: str)->str:
...
def read_text_files(index: dict, encoding: str, path: str) -> list:
    ...
    for item in index.values():
        filepath = Path(path).joinpath(item['File'])
        text_string = read_text(filepath, encoding)
